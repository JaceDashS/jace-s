...
export async function POST(
  ...
  return withApiLogging(request, `/api/online-sequencer/rooms/${roomCode}/allow-join`, async () => {
    ...
    const response: AllowJoinResponse = {
      ...
      logError('POST /api/online-sequencer/rooms/:roomCode/allow-join', error, { roomCode, duration });
